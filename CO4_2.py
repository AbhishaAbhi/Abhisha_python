#create a bank account with members, account number, account name, type of account, and balance. Write a constructor and method to deposit at the bank and withdraw an amount from bank?
